<template>
  <div class="app-container">
    <h2>Danh sách người dùng chờ phê duyệt</h2>
    <br>
    <el-table
    ...
    >
      ...
      <el-table-column label="Tài khoản" min-width="50px" align="center">
        <template slot-scope="{row}">
          <span >{{ row.name }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Họ và tên" min-width="50px" align="center">
        <template slot-scope="{row}">
